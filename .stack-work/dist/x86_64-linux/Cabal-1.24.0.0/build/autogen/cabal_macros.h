...
/* package postgresql-simple-url-0.1.0.1 */
#define VERSION_postgresql_simple_url "0.1.0.1"
...
#define CURRENT_COMPONENT_ID "my-project-1.0"

#define CURRENT_PACKAGE_KEY "my-project-1.0"
